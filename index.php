...
<body>
	...
	<main>
        ...
        <section class="to-do-list">
            ...
            <div data-js-taches>
            <!-- Je ne sais pas si c'est autorisé de toucher directement ici, donc je vais laisser un commentaire. -->
            <!-- <?php
                // Générer les options dynamiquement
                require_once('assets/requetes/fonctionsDB.php');
                $toutesTaches = selectionnerToutesTaches();
                
                // Récupération des résultats sous forme de tableau associatif
                while ($tache = mysqli_fetch_assoc($toutesTaches)) { 
